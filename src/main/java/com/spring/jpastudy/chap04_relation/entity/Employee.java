...
@Setter @Getter
@ToString(exclude = "department") // 연관관계 필드는 제외 : 사원 조회할 경우 부서 제외됨.
...
public class Employee {
    ...
    @ManyToOne(fetch = FetchType.EAGER) // 나를 기준으로 다:1 = employee : department
    @JoinColumn(name = "dept_id") // 상대방의 pk 작성 //FK 컬럼명
    private Department department;

//    @ManyToOne
//    @JoinColumn(name = "receive_dept_id") //pk 2개 생성
