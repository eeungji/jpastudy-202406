package com.spring.jpastudy.chap05.entity.repository;
...
class PurchaseRepositoryTest {
    ...
    void createPurchaseTest() {
        ...
        Purchase purchase = Purchase.builder()
                .user(user2) //어떤 유저가 어떤 물건을 구입했는지
                .goods(goods1) //user2가 goods1을 샀따
                .build();

        //when
        purchaseRepository.save(purchase);

        //영속성 컨텍스트를 초기화하면 SELET문을 볼 수 있다. 영속성 테스트 안해야 성능 좋음.
        em.flush();
        em.clear();
